...
class Muallif(models.Model):
    ...
    ism = models.CharField(max_length=255)
    jins = models.CharField(choices=Jins_choices, max_length=20)
...
class Kitob(models.Model):
    ...
    def __str__(self):
        if self.muallif:
            return str(f"{self.muallif}: {self.nom}")
        return self.nom
...
class Kutubxonachi(models.Model):
    ...
    ism = models.CharField(max_length=255)
    ish_vaqti = models.CharField(choices=ISH_VAQTI_CHOICES, default='08:30-12:30')
